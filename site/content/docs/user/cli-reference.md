...
- [Installation Guide](/docs/user/installation/) - Install aicr
- [Agent Deployment](/docs/user/agent-deployment/) - Kubernetes agent setup
- [API Reference](/docs/user/api-reference/) - Programmatic access
- [Architecture Docs](/docs/contributor/) - Internal architecture
- [Data Architecture](/docs/contributor/data/) - Recipe data system details
